...
<div class="mb-6">
    ...
    <p class="text-gray-600">Welcome back, {{ $agent->name }}</p>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="flex items-baseline">
            <span class="text-3xl font-bold text-gray-900">{{ $verifiedLandlords->count() }}</span>
            <span class="text-gray-500 ml-2">verified {{ Str::plural('landlord', $verifiedLandlords->count()) }}</span>
        </div>
        <div class="mt-4">
            <a href="{{ route('agent.landlords') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                View all landlords
            </a>
        </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="flex items-baseline">
            <span class="text-3xl font-bold text-gray-900">{{ $pendingLandlordsCount }}</span>
            <span class="text-gray-500 ml-2">pending {{ Str::plural('request', $pendingLandlordsCount) }}</span>
        </div>
        <div class="mt-4">
            <a href="{{ route('agent.landlords') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="flex items-baseline">
            <span class="text-3xl font-bold text-gray-900">{{ $pendingReviewsCount }}</span>
            <span class="text-gray-500 ml-2">pending {{ Str::plural('review', $pendingReviewsCount) }}</span>
        </div>
        <div class="mt-4">
            <a href="{{ route('agent.reviews.pending') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="flex items-baseline">
            <span class="text-3xl font-bold text-gray-900">{{ $rejectedReviewsCount }}</span>
            <span class="text-gray-500 ml-2">rejected {{ Str::plural('review', $rejectedReviewsCount) }}</span>
        </div>
        <div class="mt-4">
            <a href="{{ route('agent.reviews.rejected') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
...
<div class="mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <a href="{{ route('agent.landlords') }}" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow flex items-center">
            <div class="mr-4">
                <span class="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="{{ route('agent.tenant.search') }}" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow flex items-center">
            <div class="mr-4">
                <span class="h-10 w-10 rounded-full bg-green-100 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="{{ route('agent.properties') }}" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow flex items-center">
            <div class="mr-4">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach($verifiedLandlords->take(5) as $landlord)
                        <tr>
