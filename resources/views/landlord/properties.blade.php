...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="{{ route('landlord.property.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
        Add New Property
    </a>
</div>
                ...
                <div class="p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-700">{{ $reviewCount }} {{ Str::plural('review', $reviewCount) }} submitted</span>
                        </div>
                    </div>
                    
                    <div class="mt-6 flex justify-between items-center border-t pt-4">
                        <a href="{{ route('landlord.property.show', $property) }}" class="text-blue-600 hover:text-blue-800 font-medium">
                            View Details
                        </a>
                        <div class="flex space-x-2">
                            <a href="{{ route('landlord.property.edit', $property) }}" class="text-gray-500 hover:text-gray-700">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                </svg>
                            </a>
                            
                            <form method="POST" action="{{ route('landlord.property.destroy', $property) }}" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this property?');">
                                @csrf
                                @method('DELETE')
