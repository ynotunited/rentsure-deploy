...
<div class="relative">
    ...
    <div class="lg:hidden fixed top-16 left-0 right-0 bottom-0 z-40" x-data="{ 
        ...
        <div x-show="currentScreen === 1" 
             ...
             class="h-full relative overflow-hidden" style="background-image: url('{{ asset('images/34555666.png') }}'); background-size: cover; background-position: center;">
        ...
        <div class="py-16 bg-gradient-to-r from-[#0000ff] to-[#00001a] text-white">
            <div class="max-w-5xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                <div class="flex justify-center mb-6">
                    <img src="{{ asset('images/rentsure-logowhite.png') }}" alt="RentSure Logo" class="h-16 w-auto">
                </div>
                ...
                <div class="flex justify-center space-x-4">
                    <a href="{{ route('register') }}" class="inline-block px-6 py-3 bg-[#0000ff] text-white rounded-md font-medium hover:bg-[#00001a] transition-colors">
                        Get Started
                    </a>
                    <a href="{{ route('properties.index') }}" class="inline-block px-6 py-3 bg-green-600 text-white rounded-md font-medium hover:bg-green-700 transition-colors">
                        View Properties
                    </a>
...
<div class="relative">
    ...
    <div class="py-16 bg-[#0000ff]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="{{ route('register') }}" class="inline-block px-8 py-3 bg-[#00001a] text-white rounded-md font-medium hover:bg-[#aaaaaa] transition-colors">
                Register Now
            </a>
        </div>
    </div>
