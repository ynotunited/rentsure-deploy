...
<head>
    ...
    <title><?php echo e(config('app.name', 'RentSure')); ?> - Mobile Only</title>
...
<body>
    <div class="mobile-only-container">
        <div class="mb-6 flex justify-center">
            <img src="<?php echo e(asset('images/rentsure-logoblack.png')); ?>" alt="RentSure Logo" class="h-12 w-auto">
        </div>
        ...
        <div class="flex justify-center">
            <a href="<?php echo e(url('/')); ?>" class="px-6 py-3 bg-[#0000ff] text-white rounded-md font-medium hover:bg-[#00001a] transition-colors">
                Try Again on Mobile
            </a>
        </div>
...
</html><?php /**PATH C:\laragon\www\rentsure\resources\views/mobile-only.blade.php ENDPATH**/ ?>