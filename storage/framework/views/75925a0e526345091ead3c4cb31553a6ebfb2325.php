...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="relative">
                ...
                <input id="password" type="password" name="password" required autocomplete="current-password"
                       class="w-full pl-12 pr-12 py-4 bg-white dark:bg-gray-800 border-0 rounded-2xl text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-sm <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-right mb-6">
                <?php if(Route::has('password.request')): ?>
                    <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300">Forgot Password?</a>
                <?php endif; ?>
            </div>
            ...
            <div class="text-center">
                <p class="text-gray-500 dark:text-gray-400 text-sm">
                    Don't have account? 
                    <a href="<?php echo e(route('register')); ?>" class="font-semibold text-[#0000ff] hover:text-blue-700">Sign Up</a>
                </p>
            </div>
        </form>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\rentsure\resources\views/auth/login.blade.php ENDPATH**/ ?>